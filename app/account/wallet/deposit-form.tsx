...
function InputField({
  ...
  return (
    <div>
      <label className="mb-2.5 block text-[13px] font-bold text-slate-800 dark:text-slate-200">
        {label}
      </label>
      <input
        name={name}
        ...
        inputMode={inputMode}
        className="h-14 w-full rounded-2xl border border-slate-200 bg-white px-4 text-[15px] text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-slate-900 focus:ring-4 focus:ring-slate-900/5 dark:border-white/10 dark:bg-[#0b1220] dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-[#60a5fa] dark:focus:ring-[#60a5fa]/10"
      />
    </div>
  )
}
...
function TransferInfoRow({
  ...
  return (
    <div className="grid grid-cols-1 gap-2 border-b border-slate-100 py-4 last:border-b-0 dark:border-white/10 sm:grid-cols-[140px_minmax(0,1fr)] sm:items-center sm:gap-4 sm:py-5">
      <div className="text-[14px] font-semibold text-slate-500 dark:text-slate-400">
        {label}
      </div>
      <div
        dir={mono ? 'ltr' : undefined}
        className={`text-left text-[15px] font-bold text-slate-950 dark:text-slate-100 sm:text-left sm:text-[17px] ${
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .btn-12:hover:after {
            background: linear-gradient(
              ...
              transparent 0,
              transparent 25%,
              rgba(96, 165, 250, 0.14) 25%,
              rgba(96, 165, 250, 0.14) 50%,
              transparent 50%,
              transparent 75%,
              rgba(96, 165, 250, 0.14) 75%
            );
          }
        }
      `}</style>
      ...
      <form action={createWalletDepositRequestWithUploadAction} className="w-full space-y-6">
        ...
        <div className="w-full">
          <div className="w-full space-y-6">
            <section className="w-full rounded-[28px] border border-slate-200 bg-white p-4 shadow-[0_18px_50px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-[#111827] dark:shadow-[0_18px_48px_rgba(0,0,0,0.32)] sm:rounded-[32px] sm:p-6">
              <h3 className="mt-2 text-[22px] font-black tracking-tight text-slate-950 dark:text-slate-100 sm:text-[25px]">
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        isSelected
                          ? 'border-blue-600 bg-white shadow-none ring-2 ring-blue-100 dark:border-[#60a5fa] dark:bg-[#0b1220] dark:ring-[#60a5fa]/20'
                          : 'border-slate-200 bg-white hover:-translate-y-1 hover:border-slate-300 hover:shadow-[0_18px_40px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#0b1220] dark:hover:border-white/20 dark:hover:shadow-[0_18px_40px_rgba(0,0,0,0.34)]',
                      ].join(' ')}
                    >
                      <div
                        className={[
                          ...
                          isSelected
                            ? 'border-blue-200 bg-white dark:border-[#60a5fa]/40 dark:bg-[#0b1220]'
                            : 'border-slate-100 bg-slate-50 dark:border-white/10 dark:bg-[#111827]',
                        ].join(' ')}
                      >
                        <div className="flex h-[92px] w-full items-center justify-center overflow-hidden bg-white p-4 dark:bg-[#0b1220] sm:h-[170px] sm:p-4">
                          <img
                            src={imageSrc}
                            alt={method.name_en}
            ...
            {selectedMethod ? (
              activeAccount ? (
                <section className="w-full overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-[#111827] dark:shadow-[0_18px_48px_rgba(0,0,0,0.32)] sm:rounded-[32px]">
                  <div className="border-b border-slate-200 bg-slate-50/70 px-4 py-4 dark:border-white/10 dark:bg-[#0f172a] sm:px-6 sm:py-5">
                    <div className="mt-1 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                      <div>
                        <h3 className="text-[22px] font-black tracking-tight text-slate-950 dark:text-slate-100 sm:text-[25px]">
                          Transfer Details
                        </h3>
                      </div>
                    </div>
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="mx-auto max-w-4xl rounded-[22px] border border-slate-200 bg-white px-4 dark:border-white/10 dark:bg-[#0b1220] sm:rounded-[28px] sm:px-5">
                ...
                <section className="w-full rounded-[28px] border border-amber-200 bg-amber-50 p-5 text-amber-800 shadow-[0_10px_30px_rgba(245,158,11,0.08)] dark:border-amber-400/25 dark:bg-amber-400/10 dark:text-amber-200 sm:rounded-[32px] sm:p-6">
            ...
            <section className="w-full rounded-[28px] border border-slate-200 bg-white p-4 shadow-[0_18px_50px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-[#111827] dark:shadow-[0_18px_48px_rgba(0,0,0,0.32)] sm:rounded-[32px] sm:p-6">
              ...
              <div className="mt-6 flex justify-center">
                <div className="w-full max-w-[420px] rounded-[20px] border border-[rgb(159,159,160)] bg-white px-3 pb-3 pt-8 text-center shadow-[0_10px_60px_rgb(218,229,255)] dark:border-white/10 dark:bg-[#0b1220] dark:shadow-[0_18px_48px_rgba(0,0,0,0.32)]">
                  <span className="block text-[1.8rem] font-medium text-black dark:text-slate-100">
                    Upload your file
                  </span>

                  <p className="mt-[10px] text-[0.9375rem] text-[rgb(105,105,105)] dark:text-slate-400">
                    File should be an image
                  </p>

                  <label
                    htmlFor="receipt_file"
                    className="mt-[2.1875rem] flex cursor-pointer flex-col items-center justify-center gap-[10px] rounded-[10px] border-2 border-dashed border-[rgb(171,202,255)] bg-white p-[10px] text-[#444] transition hover:border-[rgba(17,17,17,0.616)] hover:bg-[rgba(0,140,255,0.164)] dark:border-[#60a5fa]/35 dark:bg-[#111827] dark:text-slate-300 dark:hover:border-[#60a5fa] dark:hover:bg-[#2563eb]/10"
                  >
                    <span className="text-[20px] font-bold text-[#444] transition hover:text-[#222] dark:text-slate-200 dark:hover:text-white">
                      Drop files here
                    </span>
                    ...
                    <input
                      ...
                      className="block w-full max-w-full rounded-[10px] border border-[rgba(8,8,8,0.288)] bg-white p-[2px] text-[#444] file:ml-5 file:cursor-pointer file:rounded-[10px] file:border-none file:bg-[#084cdf] file:px-5 file:py-2.5 file:text-white file:transition hover:file:bg-[#0d45a5] dark:border-white/10 dark:bg-[#0b1220] dark:text-slate-300 dark:file:bg-[#2563eb] dark:hover:file:bg-[#1d4ed8]"
                    />
                  </label>
