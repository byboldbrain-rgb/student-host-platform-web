...
export const metadata: Metadata = {
  title: {
    absolute: 'Navienty | منصة سكن الطلاب في مصر بدون عمولة',
  },
  description:
    'ابحث عن سكن طلاب وسكن طالبات في مصر حسب المدينة والمنطقة، قارن الأسعار والصور والموقع، وتواصل مباشرة مع المضيف بدون عمولة على الطالب.',
  alternates: {
    canonical: SITE_URL,
  },
  robots: {
  ...
  openGraph: {
    title: 'Navienty | منصة سكن الطلاب في مصر بدون عمولة',
    description:
      'ابحث وقارن بين أماكن السكن الطلابي حسب المدينة والمنطقة، وشاهد الأسعار والصور وتواصل مباشرة بدون عمولة على الطالب.',
    url: SITE_URL,
    siteName: SITE_NAME,
    locale: 'ar_EG',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Navienty student housing platform in Egypt',
      },
    ],
  },
  twitter: {
    ...
    title: 'Navienty | منصة سكن الطلاب في مصر بدون عمولة',
    description:
      'ابحث عن سكن طلاب قريب من جامعتك وقارن الأسعار والصور وتواصل مباشرة بدون عمولة.',
    images: [APP_LOGO_URL],
  },
}
...
export default async function HomePage({
  ...
  const homePageJsonLd = {
    ...
    name: 'Navienty | منصة سكن الطلاب في مصر بدون عمولة',
    description:
      'الصفحة الرئيسية لمنصة Navienty للبحث عن سكن الطلاب والطالبات حسب المدينة والمنطقة والأسعار.',
    url: SITE_URL,
    inLanguage: ['ar-EG', 'en'],
    isPartOf: {
      '@type': 'WebSite',
    ...
    about: [
      { '@type': 'Thing', name: 'سكن طلاب في مصر' },
      { '@type': 'Thing', name: 'سكن طالبات في مصر' },
      { '@type': 'Thing', name: 'Student accommodation in Egypt' },
    ],
    primaryImageOfPage: {
      '@type': 'ImageObject',
      url: APP_LOGO_URL,
