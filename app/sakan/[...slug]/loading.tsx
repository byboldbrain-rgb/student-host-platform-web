...
function ShimmerBlock({ className = '' }: { className?: string }) {
  return (
    <div
      aria-hidden="true"
      className={`navienty-sakan-shimmer ${className}`}
    />
  )
}
...
function MobileHeaderSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="navienty-sakan-mobile-header md:hidden"
    >
      <div className="flex h-[82px] items-center justify-center">
        <ShimmerBlock className="navienty-sakan-shimmer--brand h-10 w-8 rounded-md" />
      </div>
      ...
      <div className="px-3 pb-2">
        ...
        >
          ...
          <ShimmerBlock className="navienty-sakan-shimmer--accent h-[50px] w-[82px] shrink-0 rounded-full" />
        </div>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-24 max-w-7xl items-center gap-5 px-6 lg:px-8">
        <ShimmerBlock className="navienty-sakan-shimmer--brand h-12 w-10 shrink-0 rounded-md" />
        ...
        <div className="flex min-w-0 flex-1 justify-center">
          <div className="flex h-16 w-full max-w-[760px] items-center rounded-full border border-slate-200 bg-white p-1.5 shadow-[0_8px_26px_rgba(15,23,42,0.08)] dark:border-white/10 dark:bg-[#0b1220]">
            ...
            <ShimmerBlock className="navienty-sakan-shimmer--accent h-[52px] w-[68px] shrink-0 rounded-full" />
          </div>
        </div>
...
function MobileMapSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="navienty-sakan-mobile-map md:hidden"
    >
      <div className="absolute inset-0 navienty-sakan-map-background" />
...
function SeoStatisticsSkeleton() {
  return (
    <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={`seo-stat-${index}`}
          className="rounded-[18px] border border-slate-200 bg-white p-3 dark:border-white/10 dark:bg-white/[0.04]"
        >
          <ShimmerBlock className="h-3 w-[64%] rounded-full" />
          <ShimmerBlock className="mt-3 h-5 w-[46%] rounded-full" />
        </div>
      ))}
    </div>
  )
...
function SeoContentSkeleton({ mobile = false }: { mobile?: boolean }) {
  return (
    <div
      aria-hidden="true"
      className={`rounded-[26px] border border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-[#0b1220] ${
        mobile ? 'p-5' : 'p-8'
      }`}
      dir="rtl"
    >
      ...
      <ShimmerBlock className="h-7 w-[72%] rounded-full" />

      <div className="mt-5 space-y-3">
        <ShimmerBlock className="h-4 w-full rounded-full" />
        <ShimmerBlock className="h-4 w-[96%] rounded-full" />
        <ShimmerBlock className="h-4 w-[83%] rounded-full" />
      </div>

      <SeoStatisticsSkeleton />

      <div className="mt-8">
        <ShimmerBlock className="mb-4 h-6 w-32 rounded-full" />

        <div className="space-y-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <div
              key={`faq-${index}`}
              className="flex min-h-[58px] items-center justify-between gap-4 rounded-[20px] border border-slate-200 bg-white px-4 dark:border-white/10 dark:bg-white/[0.04]"
            >
              <ShimmerBlock className="h-4 w-[68%] rounded-full" />
      ...
      <div className="mt-8">
        <ShimmerBlock className="mb-4 h-6 w-36 rounded-full" />
...
function MobileBottomSheetSkeleton() {
  return (
    <section
      aria-hidden="true"
      className="navienty-sakan-mobile-sheet md:hidden"
    >
  ...
  return (
    ...
    >
      <div className="flex min-h-[112px] items-center justify-between gap-8">
        ...
        <ShimmerBlock className="navienty-sakan-shimmer--accent h-12 w-40 shrink-0 rounded-full" />
      </div>
    </div>
  )
}
...
function PaginationSkeleton() {
  return (
    ...
    >
      ...
      <ShimmerBlock className="navienty-sakan-shimmer--accent h-10 w-10 rounded-full" />
      <ShimmerBlock className="h-10 w-10 rounded-full" />
      <ShimmerBlock className="h-10 w-10 rounded-full" />
      <ShimmerBlock className="h-10 w-10 rounded-full" />
    </div>
...
function DesktopContentSkeleton() {
  return (
    <>
      ...
      <section className="mx-auto hidden max-w-5xl px-8 pb-12 lg:block">
        <SeoContentSkeleton />
      </section>
    </>
  )
...
function MobileBottomNavSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="navienty-sakan-mobile-nav md:hidden"
      dir="rtl"
    >
      <div className="navienty-sakan-mobile-nav__inner">
        {Array.from({ length: 3 }).map((_, index) => (
          <div
          ...
          >
            <ShimmerBlock
              className={`h-[22px] w-[22px] rounded-full ${
                index === 0 ? 'navienty-sakan-shimmer--accent' : ''
              }`}
            />
    ...
    >
      <div className="mx-auto max-w-7xl px-12 pb-9 pt-[72px]">
        <div className="grid grid-cols-[minmax(0,1.5fr)_320px_280px] items-start gap-[72px]">
          <ShimmerBlock className="navienty-sakan-shimmer--footer h-20 w-[78%] rounded-3xl" />

          <div className="space-y-4">
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-7 w-32 rounded-full" />
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-5 w-24 rounded-full" />
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-5 w-20 rounded-full" />
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-5 w-24 rounded-full" />
          </div>

          <div className="space-y-4">
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-7 w-32 rounded-full" />
            <ShimmerBlock className="navienty-sakan-shimmer--footer h-5 w-48 rounded-full" />
          </div>
        </div>
      </div>
    </footer>
    ...
    >
      <style>{`
        ...
        .navienty-sakan-shimmer::after {
          ...
          animation: navienty-sakan-shimmer-animation 1.35s ease-in-out infinite;
          will-change: transform;
        }

        .navienty-sakan-shimmer--accent,
        .navienty-sakan-shimmer--brand {
          background: #155dfc;
          box-shadow:
        ...
        .navienty-sakan-shimmer--accent::after,
        .navienty-sakan-shimmer--brand::after {
          background: linear-gradient(
            90deg,
            transparent 0%,
        ...
        .navienty-sakan-shimmer--footer {
          background: rgba(255, 255, 255, 0.23);
          box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.06);
        }

        .navienty-sakan-shimmer--footer::after {
          background: linear-gradient(
            90deg,
            transparent 0%,
        ...
        .navienty-sakan-mobile-nav::before {
          content: '';
          position: absolute;
          inset: 0;
          pointer-events: none;
        ...
        .navienty-sakan-mobile-nav__inner {
          position: relative;
          z-index: 1;
          display: grid;
          height: 70px;
        ...
        .dark .navienty-sakan-mobile-header {
          background: rgba(5, 8, 22, 0.97);
        }

        .dark .navienty-sakan-mobile-map {
          background: #111827;
        }

        .dark .navienty-sakan-mobile-sheet {
          background: #050816;
        }

        .dark .navienty-sakan-mobile-nav {
          border-color: rgba(255, 255, 255, 0.16);
          background:
            linear-gradient(
              135deg,
      ...
      <span className="sr-only">Loading student housing</span>
