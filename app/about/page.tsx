...
const featuredLogos = [
  {
    ...
    src: "https://i.ibb.co/bgVNnCSr/assiut-university-logo-png-seeklogo-445591.png",
  },
  {
    name: "University Logo 2",
    src: "https://i.ibb.co/fYYt7DHv/Symbol.png",
  },
  {
    name: "Navienty",
  ...
  {
    name: "EELU",
    src: "https://i.ibb.co/qYQYrRKb/eelu-logo.png",
  },
  {
    name: "University Logo 5",
    src: "https://i.ibb.co/qY0j2Fp9/images-3.jpg",
  },
  {
    name: "University Logo 6",
    src: "https://i.ibb.co/20F6D2sK/images-2.png",
  },
];

const stats = [
  {
    title: "Built for the next generation of students",
    subtitle: "",
  },
  {
    title: "All-in-one",
...
const features = [
  {
    ...
    text: "We partner with only the most trusted providers to ensure every service on our platform meets the highest standards of quality and safety. Your peace of mind is our priority.",
    bg: "bg-[#e8efec]",
    iconColor: "text-[#2c6758]",
  },
  {
    icon: ShieldCheck,
    title: "Unbeatable Value",
    text: "Access premium student services at the most competitive rates. We are committed to transparency, ensuring you get the best value for your investment without hidden costs.",
    bg: "bg-blue-600",
  ...
  },
  {
    ...
    text: "Our dedicated team understands the unique challenges of student life. We’re here around the clock to provide expert guidance and support whenever you need it.",
    bg: "bg-[#e8efec]",
    iconColor: "text-[#2c6758]",
  },
];
...
function PillButton({ children }: { children: React.ReactNode }) {
  return (
    <button className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-3 text-xs font-semibold text-white shadow-[0_6px_18px_rgba(37,99,235,0.25)] transition hover:scale-[1.02] md:px-6 md:py-3.5 md:text-sm">
      {children}
    </button>
  );
}
...
export default function AboutPage() {
  ...
  <div className="flex h-[72px] w-full items-center justify-between px-4 pt-2 md:px-6 lg:px-8">
    ...
    >
      ...
      <section className="px-4 pb-8 pt-6 md:px-6 xl:px-0 xl:pb-12 xl:pt-8">
        <div className="mx-auto rounded-[30px] bg-[#f2f1f8] px-7 py-12 md:px-10 md:py-16 xl:px-14 xl:py-20">
          <div className="mx-auto max-w-[760px] xl:mx-0">
            <SectionTitle black="About" purple="Navienty" />

            <div className="mt-6 max-w-[620px] space-y-4 text-[16px] leading-[1.7] text-[#22232c] md:text-[18px] xl:text-[19px]">
              <p>
                Navienty is Egypt’s premier all-in-one ecosystem designed to
                empower the modern student. Since 2026, we have been dedicated
                to elevating the student experience by providing seamless access
                to essential services—from premium housing to vital academic and
                lifestyle resources. We built Navienty to bridge the gap between
                student needs and world-class solutions, ensuring you have
                everything required to excel in one unified platform.
              </p>
            </div>
      ...
      <section className="px-4 pb-8 md:px-6 xl:px-0 xl:pb-12">
        <div className="mx-auto overflow-hidden rounded-[28px] bg-white pb-7 pt-4 shadow-sm md:pb-8 md:pt-5">
          <h3 className="px-6 pb-2 text-center text-3xl font-bold tracking-[-0.04em] text-blue-600 md:px-10 md:text-4xl xl:px-14">
            Find us at
          </h3>

          <div className="mt-3 overflow-hidden">
            <div
              className="flex w-max items-center gap-8 md:gap-10 xl:gap-14"
              style={{ animation: "marqueeScroll 22s linear infinite" }}
            >
              {marqueeLogos.map((logo, index) => (
                <div
                  key={`${logo.name}-${index}`}
                  className="flex h-[100px] w-[200px] shrink-0 items-center justify-center rounded-xl bg-white px-4 md:h-[120px] md:w-[240px] xl:h-[135px] xl:w-[270px]"
                >
                  <img
                    src={logo.src}
                    alt={logo.name}
                    className="max-h-[99px] w-auto object-contain md:max-h-[90px] xl:max-h-[110px]"
                    loading="lazy"
                  />
                </div>
              ))}
      ...
      <section className="px-4 pb-10 md:px-6 xl:px-0 xl:pb-14">
        <div className="mx-auto rounded-[0px] bg-[#dff1f4] px-7 py-8 md:px-9 xl:px-12 xl:py-12">
          <div className="grid gap-8 xl:grid-cols-3 xl:items-center">
            {stats.map((item, index) => (
              ...
              >
                <h3
                  className={
                    index === 0
                      ? "whitespace-pre-line text-3xl font-bold leading-[1.12] tracking-[-0.04em] text-[#20212a] md:text-4xl"
                      : "text-4xl font-black leading-none tracking-[-0.05em] text-[#20212a] md:text-6xl xl:text-[68px]"
                  }
                >
                  {item.title}
                </h3>
                {item.subtitle ? (
                  <p className="mt-2 text-xl font-bold tracking-[-0.03em] text-[#20212a] md:text-3xl">
                    {item.subtitle}
                  </p>
                ) : null}
              </div>
      ...
      <section className="px-4 pb-8 md:px-6 xl:px-0 xl:pb-10">
        <div className="mx-auto max-w-[1280px]">
          <div className="mb-7">
            <SectionTitle black="Why" purple="choose us?" />
          </div>
          ...
          <div className="grid gap-6 xl:grid-cols-3 xl:gap-10">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={feature.title}
                  className={`${feature.bg} rounded-[24px] p-6 shadow-[0_6px_18px_rgba(0,0,0,0.04)] xl:min-h-[270px] xl:p-7`}
                >
                  <h3
                    className={`max-w-[320px] text-[20px] font-bold leading-[1.2] tracking-[-0.04em] xl:text-[22px] ${
                      isMiddle ? "text-white" : "text-[#20212a]"
                    }`}
                  >
                    {feature.title}
                  </h3>
                  <p
                    className={`mt-5 max-w-[350px] text-[15px] leading-[1.7] xl:text-[16px] ${
                      isMiddle ? "text-white" : "text-[#24252e]"
                    }`}
                  >
                    {feature.text}
                  </p>
      ...
      <section className="px-4 pb-6 md:px-6 xl:px-0 xl:pb-8">
        <div className="mx-auto bg-[#def1f3] px-7 py-12 md:px-9 xl:px-12 xl:py-14">
          <div className="mx-auto max-w-[650px] text-center">
            ...
            <p className="mt-4 text-sm leading-6 text-[#42434c] md:text-base">
              ...
              by WhatsApp, phone or email – we&apos;re always happy to help!
            </p>
          </div>
          ...
          <div className="mx-auto mt-8 grid max-w-[860px] gap-4 md:grid-cols-2 xl:grid-cols-3">
            {contactCards.map((card) => (
              <a
                ...
                className="rounded-lg bg-white p-5 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                ...
                <h4 className="mt-3 text-base font-bold text-[#20212a]">
                  {card.title}
                </h4>
                <p className="mt-2 text-sm text-[#555660]">{card.text}</p>
              </a>
            ))}
          </div>
        </div>
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 9v6m0 4h.01M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
              />
            </svg>
            <span className="mobile-bottom-nav__label">About</span>
          </Link>
        </div>
      </nav>
    </main>
