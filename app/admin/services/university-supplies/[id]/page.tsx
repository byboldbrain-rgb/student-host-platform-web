...
import UniversitySuppliesProviderEditor from './UniversitySuppliesProviderEditor'
...
export default async function UniversitySuppliesProviderDetailsPage({
  params,
}: {
  ...
  const provider = data as UniversitySuppliesProvider
  ...
  return (
    <main className="min-h-screen bg-[#f6f8fb]">
      <div className="mx-auto max-w-[1440px] px-4 py-5 md:px-6 lg:px-8">
        ...
        <UniversitySuppliesProviderEditor
          provider={provider}
