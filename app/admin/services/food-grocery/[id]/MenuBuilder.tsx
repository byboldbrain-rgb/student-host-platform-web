  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-[#101828]">Menu builder</h2>
          <p className="mt-1 text-sm text-[#667085]">
            Scalable editing flow for large restaurant menus.
          </p>
        </div>
                            ...
                            >
                              <div className="flex items-start justify-between gap-3">
                                <div className="min-w-0">
                                  <p className="truncate text-sm font-semibold text-[#101828]">
                                    {item.name_en || item.name_ar || 'Untitled Item'}
                                  </p>
          ...
          {selectedItem ? (
            <div className="space-y-6">
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div>
                  <FieldLabel>Item Name EN</FieldLabel>
                  <Input
                    ...
                    {(itemImagePreviews[selectedItem.id] || selectedItem.image_url) ? (
                      <div className="overflow-hidden rounded-2xl border border-[#eaecf0] bg-[#f9fafb]">
                        <img
                          ...
                          alt={selectedItem.name_en || 'Item image'}
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 p-4">
                          <div className="min-w-0">
                            ...
                            {itemImageFiles[selectedItem.id] ? (
                              ...
                              <p className="mt-1 text-xs text-[#667085] truncate"></p>
                            ) : null}
                          </div>
            ...
            <div className="flex min-h-[520px] items-center justify-center rounded-[20px] border border-dashed border-[#d0d5dd] bg-white px-6 text-center">
              <div>
                <h3 className="text-lg font-semibold text-[#101828]">No item selected</h3>
                <p className="mt-2 text-sm text-[#667085]">
                  Add a new item or choose one from the left panel to start editing.
                </p>
              </div>
            </div>
          )}
